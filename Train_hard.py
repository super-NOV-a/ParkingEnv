...
if __name__ == "__main__":
    ...
    parking_cfg = dict(
        ...
        # 不同等级之间难度差别大
        gap_base = 2,       # 在random中使用的内容
        gap_step = 0.15,     # 总共十个level  gap与occupy_prob根据level在min/max之间调节
        gap_min = 0.5,
        occupy_prob_base = 0.5,   # parking中是车位附近的障碍车位概率
        ...
        # 训练模型管理项 ↓↓↓
        logdir="fc_easy_rnn", # 可以此处指定log_dir！ 继续训练时会保存在此处
        ...
        model_type="mlp_rnn",              # ← change to mlp / mlp_rnn / conv / conv_rnn
    )
