...
if __name__ == "__main__":
    ...
    if args.logdir is None:
        ...
        args.logdir = Path(f"runs/ppo_{args.vehicle_type}_empty")
    ...
    # latest_ckpt = "C:\AI_Planner\RL\\runs\ppo_arc_cnn1\checkpoints\ppo_arc_1000000_steps.zip"
    latest_ckpt = None # 默认是 None           todo 继续训练时可以从此处修改
    if args.resume:
    ...
    policy_kwargs = dict(
        features_extractor_class=CustomMLP,   # RadarConvFusion,   # 使用环形卷积处理雷达
