...
class Lidar2D:
    ...
    def scan(self, x, y, yaw):
        ...
        for i, ray in enumerate(rays):
            ...
            candidate_indices = self.obstacle_tree.query(ray)
            
            if candidate_indices.size == 0:
                continue
                
            # 获取候选障碍物几何体
            possible_obstacles = [self.obstacles[idx] for idx in candidate_indices]
            
            # 合并可能相交的障碍物
            merged_obstacles = unary_union(possible_obstacles)
